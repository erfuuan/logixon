...
export default {
    async create(data) {
        try {
            return await Model.Rules.create(data);
        } catch (err) {
    ...
    async getOne(condition) {
        try {
            return await Model.Rules.findOne({ where: condition, raw: true });
        } catch (err) {
    ...
    async getAll() {
        try {
            return await Model.Rules.findAll({ raw: true });
        } catch (err) {
    ...
    async update(id, data) {
        try {
            const rule = await Model.Rules.findByPk(id);
            if (!rule) return null;
